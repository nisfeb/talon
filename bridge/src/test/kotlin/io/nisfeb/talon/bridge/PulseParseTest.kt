...
class PulseParseTest {
    ...
    fun streamsResolveTheirDeviceNames() {
        ...
        val streams = Pulse.parseStreams(
            """[{"index":42,"sink":7,"volume":{"mono":{"value":52429,"value_percent":"80%","db":"-5.81 dB"}},
                 "properties":{"application.name":"Brave","application.process.id":"123"}},
        ...
        assertEquals(
            listOf(
                Pulse.Stream(42, "Brave", 123L, "TalonBridgeSpace", volume = 80),
