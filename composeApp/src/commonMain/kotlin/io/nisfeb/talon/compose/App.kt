...
fun App(
    ...
    key(shipKey) {
        ...
        LaunchedEffect(partyLine, callController) {
            // A 1:1 call and a party line can be live at the same time,
            // and every setMuted is per-track — CallController's mute
            // physically cannot quiet the party mic. Answering a private
            // call while unmuted on a group line broadcast the whole
            // conversation to the room. Mute the line for the call.
                    ...
                    openThreadParent != null && openChat != null && !expanded -> {
                        ...
                        val detailSlot: (@Composable () -> Unit)? = when {
                            ...
                            openChat != null -> ({
                                ...
                                // Shared with the Android root; see
                                // rememberPartyRecording.
                                val recordingControls = io.nisfeb.talon.ui.rememberPartyRecording(
                                    ...
                                    conversationTitle =
                                        partyContacts.conversationLabel(openChat.orEmpty()),
                                ...
                                DmChatScreen(
                                    ...
                                    partyLineBar = {
                                        ...
                                        partyLine?.let { line ->
                                            ...
                                            // Our own desk relays the
                                            // moderate poke; a wire-4 desk
                                            // nacks it invisibly, so don't
                                            // pretend to persist.
                                            val moderateWire =
