...
// app/src/main/java/io/nisfeb/talon/ui/Contacts.kt during the CMP
// desktop port (Task D4 prerequisite). Keep this file in lockstep
// with the production copy until app/ is removed in Stage F.
