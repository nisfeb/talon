 ...
 *  - isLocalTriageSupported — D (llama.cpp on the JVM, or a local Ollama); A, i: no rung built yet, the rules alone read messages.
 *
 ...
 * and iOS: false until their rungs land; the rules read messages
 * alone there, and the copy says so.
 */
