...
// app/src/main/java/io/nisfeb/talon/update/UpdateChecker.kt during the
// CMP desktop port (Task D4 prerequisite). Pure Kotlin already; just
// relocated into commonMain. Keep in lockstep with the production copy
// until app/ is removed in Stage F.
