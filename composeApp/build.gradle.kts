...
val talonVersionCode = 213
val talonVersionName = "0.16.0-rc14"
...
val iconsExtendedKeep = setOf(
    ...
    "androidx/compose/material/icons/filled/ContentPasteKt.class",
    ...
    "androidx/compose/material/icons/filled/PublicKt.class",
