...
fun GroupAdminScreen(
    ...
    var group by remember { mutableStateOf<TlonChatRepo.AdminGroup?>(null) }
    var loading by remember { mutableStateOf(true) }
    var error by remember { mutableStateOf<String?>(null) }
    var memberActionTarget by remember {
        mutableStateOf<TlonChatRepo.AdminMember?>(null)
    }
...
private fun AdminBody(
    ...
    onMemberLongPress: (TlonChatRepo.AdminMember) -> Unit,
    ...
    // "image" | "cover" | null — which slot the current pick targets.
    ...
    val pickMedia = rememberLauncherForActivityResult(
        ...
        scope.launch {
            runCatching {
                ...
                val name = uri.lastPathSegment?.substringAfterLast('/') ?: "groupart"
...
private fun MemberRow(
    member: TlonChatRepo.AdminMember,
    contactMap: ContactMap,
    onLongPress: () -> Unit,
) {
